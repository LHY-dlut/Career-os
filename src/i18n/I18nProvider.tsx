...
const labels: Record<string, string> = {
  ...
  Transformer: 'Transformer 架构', LLM: '大语言模型', RAG: '检索增强生成', Agent: '智能体',
  'Text-to-SQL': '自然语言转 SQL', 'Machine Learning': '机器学习', 'Deep Learning': '深度学习',
  NLP: '自然语言处理', Inference: '推理优化', 'Project Deep Dive': '项目深挖', 'System Design': '系统设计',
  '01 Transformer': '01 Transformer 架构', '02 LLM': '02 大语言模型', '03 RAG': '03 检索增强生成',
  '04 Agent': '04 智能体', '05 Text-to-SQL': '05 自然语言转 SQL', '06 Machine Learning': '06 机器学习',
