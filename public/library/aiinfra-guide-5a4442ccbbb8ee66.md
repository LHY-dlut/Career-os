...
- [1. 环境配置](#heading-1-环境配置)
- [2. CUDA 编程模型](#heading-2-cuda-编程模型)
- [3. 内存模型](#heading-3-内存模型)
- [4. 关键概念](#heading-4-关键概念)
- [5. 第一个完整程序：向量加法](#heading-5-第一个完整程序向量加法)
- [6. 常见算子实现与优化](#heading-6-常见算子实现与优化)
- [7. Attention 算子](#heading-7-attention-算子)
- [8. AI 编译器](#heading-8-ai-编译器)
- [9. 性能分析工具](#heading-9-性能分析工具)
- [10. 进阶专题：把这些概念串起来用](#heading-10-进阶专题把这些概念串起来用)
- [11. 自我检验清单](#heading-11-自我检验清单)
- [参考资料](#heading-参考资料)
...
![CUDA programming model](https://caomaolufei.github.io/AIInfraGuide/images/CUDA%20programming%20model.png)
...
> 📌 Reduce 是典型的 **Memory-Bound** 操作（算术强度仅 0.25 FLOP/Byte），优化核心在于提升内存带宽利用率。更多进阶优化（向量化加载 `float4`、Grid Stride Loop、模板展开等）可参考 [CUDA Reduce 算子优化](https://caomaolufei.github.io/AI%20Infra/CUDA%E7%BC%96%E7%A8%8B%E4%B8%8E%E7%AE%97%E5%AD%90%E4%BC%98%E5%8C%96/CUDA%E7%BC%96%E7%A8%8B%E8%BF%9B%E9%98%B6/CUDA-Reduce%E7%AE%97%E5%AD%90%E4%BC%98%E5%8C%96/) 一文。
