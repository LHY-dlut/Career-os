...
> 来源：[ARIS-in-AI-Offer](https://github.com/wanshuiyin/ARIS-in-AI-Offer/blob/22e73822f8636ee3b52de1da6f6d2e03d1f51d4e/docs/tutorials/diffusion_post_training_tutorial.md) · 作者：Ruofeng Yang（杨若峰）及 ARIS contributors · [MIT 许可](/library/licenses/aris-ai-offer-MIT.txt)
...
8. **Flow-GRPO (Liu et al. 2025, arXiv 2505.05470)**：第一个把 GRPO 搬到 Flow Matching 的工作——ODE→SDE 同边缘转换 + denoising reduction，SD3.5-M GenEval 63% → 95%。它与 DGPO、DiffusionNFT 的完整推导和对比已独立成篇：[《现代 Diffusion 后训练》](/library/aris-ai-offer-modern-diffusion-post-training-tutorial)。
...
👉 [《现代 Diffusion 后训练：Flow-GRPO · DGPO · DiffusionNFT》](/library/aris-ai-offer-modern-diffusion-post-training-tutorial)
...
SDE 一步 + Gaussian log-prob + ratio + 闭式 KL 的可读实现见 [《现代 Diffusion 后训练》§7.1](/library/aris-ai-offer-modern-diffusion-post-training-tutorial)。
