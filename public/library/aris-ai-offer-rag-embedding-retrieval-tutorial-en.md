# RAG + Text Embeddings Interview Cheat Sheet

> 来源：[ARIS-in-AI-Offer](https://github.com/wanshuiyin/ARIS-in-AI-Offer/blob/22e73822f8636ee3b52de1da6f6d2e03d1f51d4e/docs/tutorials/rag_embedding_retrieval_tutorial_en.md) · 作者：Ruofeng Yang（杨若峰）及 ARIS contributors · [MIT 许可](/library/licenses/aris-ai-offer-MIT.txt)
...
Below is the **real run** output of [`code/rag_embedding.py`](https://raw.githubusercontent.com/wanshuiyin/ARIS-in-AI-Offer/22e73822f8636ee3b52de1da6f6d2e03d1f51d4e/docs/tutorials/code/rag_embedding.py) on **PyTorch 2.10 / CPU** (each line has an `assert`; the summary prints only if all pass):
...
The embedding / retrieval core of this tutorial has a minimal runnable version at [`docs/tutorials/code/rag_embedding.py`](https://raw.githubusercontent.com/wanshuiyin/ARIS-in-AI-Offer/22e73822f8636ee3b52de1da6f6d2e03d1f51d4e/docs/tutorials/code/rag_embedding.py):

- [`rag_embedding.py`](https://raw.githubusercontent.com/wanshuiyin/ARIS-in-AI-Offer/22e73822f8636ee3b52de1da6f6d2e03d1f51d4e/docs/tutorials/code/rag_embedding.py) — `DualEncoder` (L2-normalized bi-encoder) + `info_nce_in_batch` / `info_nce_with_hard` (in-batch + hard-negative contrastive loss) + `bm25_scores` / `rrf` / hybrid recall, with 6 `assert` sanity checks (diagonal-is-positive / normalization / temperature sharpness / with-hard shape / RRF monotone / hybrid keeps the entity chunk).
