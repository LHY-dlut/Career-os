# Optimizer / LR Schedule Interview Cheat Sheet

> 来源：[ARIS-in-AI-Offer](https://github.com/wanshuiyin/ARIS-in-AI-Offer/blob/22e73822f8636ee3b52de1da6f6d2e03d1f51d4e/docs/tutorials/optimizer_lr_schedule_tutorial_en.md) · 作者：Ruofeng Yang（杨若峰）及 ARIS contributors · [MIT 许可](/library/licenses/aris-ai-offer-MIT.txt)
...
The full runnable script is at [`code/optimizer_lr_schedule.py`](https://raw.githubusercontent.com/wanshuiyin/ARIS-in-AI-Offer/22e73822f8636ee3b52de1da6f6d2e03d1f51d4e/docs/tutorials/code/optimizer_lr_schedule.py) (pure PyTorch, a few seconds on CPU, 6 `assert`s covering [a]–[f]). The **real output** of running `python code/optimizer_lr_schedule.py`:
