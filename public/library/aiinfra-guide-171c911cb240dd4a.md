...
- [1. 什么是端侧推理](#heading-1-什么是端侧推理)
- [2. 端侧设备的四类约束](#heading-2-端侧设备的四类约束)
- [3. 从模型到 App 的完整链路](#heading-3-从模型到-app-的完整链路)
- [4. CPU、GPU、NPU 与 DSP](#heading-4-cpugpunpu-与-dsp)
- [5. 端侧运行时如何选](#heading-5-端侧运行时如何选)
- [6. 端侧优化的四个核心抓手](#heading-6-端侧优化的四个核心抓手)
- [7. 怎样做可信的端侧 Benchmark](#heading-7-怎样做可信的端侧-benchmark)
- [8. ExecuTorch 与 XNNPACK 最小实例](#heading-8-executorch-与-xnnpack-最小实例)
- [9. 常见问题与排查顺序](#heading-9-常见问题与排查顺序)
- [10. 选型建议](#heading-10-选型建议)
- [总结](#heading-总结)
