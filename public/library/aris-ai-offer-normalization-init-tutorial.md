# 归一化 / 残差 / 初始化 面试 Cheat Sheet

> 来源：[ARIS-in-AI-Offer](https://github.com/wanshuiyin/ARIS-in-AI-Offer/blob/22e73822f8636ee3b52de1da6f6d2e03d1f51d4e/docs/tutorials/normalization_init_tutorial.md) · 作者：Ruofeng Yang（杨若峰）及 ARIS contributors · [MIT 许可](/library/licenses/aris-ai-offer-MIT.txt)
...
本 tutorial 的代码在 [`docs/tutorials/code/normalization.py`](https://raw.githubusercontent.com/wanshuiyin/ARIS-in-AI-Offer/22e73822f8636ee3b52de1da6f6d2e03d1f51d4e/docs/tutorials/code/normalization.py) 有最小可跑版本（纯 PyTorch、CPU 几秒、6 个 `assert`，覆盖 [a]–[f]）。它应满足以下关键不变量：
