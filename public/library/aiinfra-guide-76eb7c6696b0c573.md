# 5.1 NVIDIA GPU架构演进：从Volta到Blackwell

> 来源：[AIInfraGuide](https://github.com/caomaolufei/AIInfraGuide/blob/a3b63eeb81d6d36a3c42c8cfc5a1bdd96e36bab1/docs/guides/%E6%A8%A1%E5%9D%97%E4%B8%80-%E5%89%8D%E7%BD%AE%E7%9F%A5%E8%AF%86/gpu/nvidia-gpu-evolution.md) · 作者：草帽路飞（caomaolufei）及 AIInfraGuide contributors · [MIT 许可](/library/licenses/aiinfra-guide-MIT.txt)


## 📑 目录

- [1. 为什么要了解 GPU 架构演进](#heading-1-为什么要了解-gpu-架构演进)
- [2. 架构演进全景图](#heading-2-架构演进全景图)
- [3. Volta 架构（2017）——AI 加速的开端](#heading-3-volta-架构2017ai-加速的开端)
- [4. Turing 架构（2018）——RT Core 与推理加速](#heading-4-turing-架构2018rt-core-与推理加速)
- [5. Ampere 架构（2020）——数据中心 AI 的分水岭](#heading-5-ampere-架构2020数据中心-ai-的分水岭)
- [6. Hopper 架构（2022）——为大模型而生](#heading-6-hopper-架构2022为大模型而生)
- [7. Blackwell 架构（2024）——万亿参数时代的基石](#heading-7-blackwell-架构2024万亿参数时代的基石)
- [8. 核心技术纵向对比](#heading-8-核心技术纵向对比)
- [9. 如何选择合适的 GPU](#heading-9-如何选择合适的-gpu)
- [总结](#heading-总结)
