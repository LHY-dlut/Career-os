...
- [1. 异构计算模型概览](#heading-1-异构计算模型概览)
- [2. Grid/Block/Thread 三级线程层次](#heading-2-gridblockthread-三级线程层次)
- [3. 线程索引计算](#heading-3-线程索引计算)
- [4. Kernel 函数与启动语法](#heading-4-kernel-函数与启动语法)
- [5. Block 大小选择策略](#heading-5-block-大小选择策略)
- [6. Warp：硬件调度的基本单位](#heading-6-warp硬件调度的基本单位)
- [7. 多维索引与实际应用](#heading-7-多维索引与实际应用)
- [8. 占用率与性能](#heading-8-占用率与性能)
- [总结](#heading-总结)
