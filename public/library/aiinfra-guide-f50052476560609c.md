...
- [1. Softmax 基础与数值问题](#heading-1-softmax-基础与数值问题)
- [2. 版本 V0：朴素实现（单线程处理一行）](#heading-2-版本-v0朴素实现单线程处理一行)
- [3. 版本 V1：Safe Softmax 三遍扫描](#heading-3-版本-v1safe-softmax-三遍扫描)
- [4. 版本 V2：Warp Shuffle 优化规约](#heading-4-版本-v2warp-shuffle-优化规约)
- [5. 版本 V3：向量化加载 float4](#heading-5-版本-v3向量化加载-float4)
- [6. 版本 V4：两遍融合 Kernel](#heading-6-版本-v4两遍融合-kernel)
- [7. 性能对比与工程建议](#heading-7-性能对比与工程建议)
- [总结](#heading-总结)
