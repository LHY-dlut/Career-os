...
> 来源：[ARIS-in-AI-Offer](https://github.com/wanshuiyin/ARIS-in-AI-Offer/blob/22e73822f8636ee3b52de1da6f6d2e03d1f51d4e/docs/tutorials/world_models_tutorial.md) · 作者：Ruofeng Yang（杨若峰）及 ARIS contributors · [MIT 许可](/library/licenses/aris-ai-offer-MIT.txt)
...
三段核心 pattern，完整实验在 [`code/world_models_toy.py`](https://raw.githubusercontent.com/wanshuiyin/ARIS-in-AI-Offer/22e73822f8636ee3b52de1da6f6d2e03d1f51d4e/docs/tutorials/code/world_models_toy.py)。三段共用 `import torch, torch.nn as nn, torch.nn.functional as F`。
...
脚本：[`code/world_models_toy.py`](https://raw.githubusercontent.com/wanshuiyin/ARIS-in-AI-Offer/22e73822f8636ee3b52de1da6f6d2e03d1f51d4e/docs/tutorials/code/world_models_toy.py)，纯 PyTorch，CPU 上几秒跑完。三个实验都有解析答案，可以逐项对照——**结论只覆盖各自的显式设定，不是论文复现**。
