...
- [1. 为什么并行需要同步](#heading-1-为什么并行需要同步)
- [2. Block 内同步：\_\_syncthreads\(\)](#heading-2-block-内同步-syncthreads)
- [3. Warp 级同步](#heading-3-warp-级同步)
- [4. Memory Fence 与内存可见性](#heading-4-memory-fence-与内存可见性)
- [5. 原子操作](#heading-5-原子操作)
- [6. 原子操作的性能优化](#heading-6-原子操作的性能优化)
- [7. 协作组（Cooperative Groups）](#heading-7-协作组cooperative-groups)
- [总结](#heading-总结)
