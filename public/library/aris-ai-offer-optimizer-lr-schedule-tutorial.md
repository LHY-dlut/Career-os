# 优化器 / LR Schedule 面试 Cheat Sheet

> 来源：[ARIS-in-AI-Offer](https://github.com/wanshuiyin/ARIS-in-AI-Offer/blob/22e73822f8636ee3b52de1da6f6d2e03d1f51d4e/docs/tutorials/optimizer_lr_schedule_tutorial.md) · 作者：Ruofeng Yang（杨若峰）及 ARIS contributors · [MIT 许可](/library/licenses/aris-ai-offer-MIT.txt)
...
完整可跑脚本见 [`code/optimizer_lr_schedule.py`](https://raw.githubusercontent.com/wanshuiyin/ARIS-in-AI-Offer/22e73822f8636ee3b52de1da6f6d2e03d1f51d4e/docs/tutorials/code/optimizer_lr_schedule.py)（纯 PyTorch、CPU 几秒、6 个 `assert` 覆盖 [a]–[f]）。运行 `python code/optimizer_lr_schedule.py` 的**真实输出**：
