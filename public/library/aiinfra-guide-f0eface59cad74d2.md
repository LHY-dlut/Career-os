...
- [1. 自回归生成：Prefill 与 Decode 两阶段](#heading-1-自回归生成prefill-与-decode-两阶段)
- [2. KV Cache：用显存换计算](#heading-2-kv-cache用显存换计算)
- [3. 关键性能指标：如何衡量"快"](#heading-3-关键性能指标如何衡量快)
- [4. 瓶颈分析：为什么 Decode 打不满算力](#heading-4-瓶颈分析为什么-decode-打不满算力)
- [5. 推理全链路拆解](#heading-5-推理全链路拆解)
- [总结](#heading-总结)
