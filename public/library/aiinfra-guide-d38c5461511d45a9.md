...
- [1. 背景与问题定义](#heading-1-背景与问题定义)
- [2. 性能分析方法论](#heading-2-性能分析方法论)
- [3. 朴素实现：建立 Baseline](#heading-3-朴素实现建立-baseline)
- [4. Thread Block级 Tiling优化](#heading-4-thread-block-级-tiling-优化)
- [5. Thread级Tiling优化](#heading-5-thread-级-tiling-优化寄存器级数据复用)
- [6. Warp 级分块优化](#heading-6-warp-级分块优化)
- [7. 向量化访存：float4 优化](#heading-7-向量化访存float4-优化)
- [8. Bank Conflict 消除](#heading-8-bank-conflict-消除)
- [9. 双缓冲与流水线](#heading-9-双缓冲与流水线)
- [10. Ampere 异步拷贝流水线](#heading-10-ampere-异步拷贝流水线)
- [11. SASS 级优化与寄存器调度](#heading-11-sass-级优化与寄存器调度)
- [12. 实战参数选择与调优指南](#heading-12-实战参数选择与调优指南)
- [总结](#heading-总结)
...
![GEMM 的定义](https://caomaolufei.github.io/AIInfraGuide/images/gemm-1.png)
...
![Thread Block 级 Tiling 优化](https://caomaolufei.github.io/AIInfraGuide/images/gemm-2.png)
...
![每个线程负责填充每个C_BLOCK中相同的位置](https://caomaolufei.github.io/AIInfraGuide/images/gemm-C_tile_bolcks.png)
...
![Thread 级 Tiling 优化：寄存器级数据复用](https://caomaolufei.github.io/AIInfraGuide/images/gemm-3.png)
...
![Warp 级分块优化](https://caomaolufei.github.io/AIInfraGuide/images/gemm-4.png)
...
![float4 下 warp(4x8) 的 Transaction 分析](https://caomaolufei.github.io/AIInfraGuide/images/gemm-5.png)
...
![方案四：8 x 8 计算区域拆分为 4 x 4 子块](https://caomaolufei.github.io/AIInfraGuide/images/gemm-7.png)
...
![方案三：Z-order 线程映射](https://caomaolufei.github.io/AIInfraGuide/images/gemm-8.png)
