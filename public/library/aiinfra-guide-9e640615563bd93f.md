...
- [1. 重复的前缀有多浪费](#heading-1-重复的前缀有多浪费)
- [2. 复用的物理基础：块级 KV 共享](#heading-2-复用的物理基础块级-kv-共享)
- [3. vLLM 的 Automatic Prefix Caching](#heading-3-vllm-的-automatic-prefix-caching)
- [4. 缓存的淘汰：LRU 与引用计数](#heading-4-缓存的淘汰lru-与引用计数)
- [5. SGLang 的 RadixAttention](#heading-5-sglang-的-radixattention)
- [6. 源码走读：vLLM APC 的哈希与匹配](#heading-6-源码走读vllm-apc-的哈希与匹配)
- [7. 适用场景与注意事项](#heading-7-适用场景与注意事项)
- [总结](#heading-总结)
