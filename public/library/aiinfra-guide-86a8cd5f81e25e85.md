...
> 来源：[AIInfraGuide](https://github.com/caomaolufei/AIInfraGuide/blob/a3b63eeb81d6d36a3c42c8cfc5a1bdd96e36bab1/docs/guides/%E6%A8%A1%E5%9D%97%E4%B8%89-%E5%88%86%E5%B8%83%E5%BC%8F%E8%AE%AD%E7%BB%83/4.1%20%E6%95%B0%E6%8D%AE%E5%B9%B6%E8%A1%8C%E8%AF%A6%E8%A7%A3.md) · 作者：草帽路飞（caomaolufei）及 AIInfraGuide contributors · [MIT 许可](/library/licenses/aiinfra-guide-MIT.txt)
...
- [1. 数据并行要解决什么问题](#heading-1-数据并行要解决什么问题)
- [2. 数据并行的数学基础](#heading-2-数据并行的数学基础)
- [3. 第一代：DataParallel（DP）](#heading-3-第一代dataparalleldp)
- [4. 第二代：DistributedDataParallel（DDP）](#heading-4-第二代distributeddataparallelddp)
- [5. AllReduce 通信量的数学推导](#heading-5-allreduce-通信量的数学推导)
- [6. 第三代：FullyShardedDataParallel（FSDP）](#heading-6-第三代fullyshardeddataparallelfsdp)
- [7. 显存账本：三代方案的定量对比](#heading-7-显存账本三代方案的定量对比)
- [8. 通信量对比：DDP vs FSDP](#heading-8-通信量对比ddp-vs-fsdp)
- [9. 选型决策指南](#heading-9-选型决策指南)
- [总结](#heading-总结)
...
![数据并行：模型复制到多卡，各卡在不同数据微批上并行前反向，再同步梯度](https://caomaolufei.github.io/AIInfraGuide/images/dp_diagram.png)
...
![朴素 DP：先完成整个反向传播，再统一同步梯度，通信期间 GPU 空闲](https://caomaolufei.github.io/AIInfraGuide/images/dp_overlap1.svg)
...
![梯度同步与反向传播重叠：靠后层的梯度先就绪即可立即同步，与更靠前层的反向计算并行](https://caomaolufei.github.io/AIInfraGuide/images/dp_overlap2.svg)
...
![梯度分桶：把多个梯度打包成一个 Bucket，只发起一次 AllReduce，减少通信次数](https://caomaolufei.github.io/AIInfraGuide/images/dp_overlap3.svg)
...
![随 DP rank 增加的吞吐量与单卡显存占用：超过某上限后吞吐量下降，单卡显存恒定](https://caomaolufei.github.io/AIInfraGuide/images/dp_scaling.svg)
