...
- [1. V1 的性能瓶颈回顾](#heading-1-v1-的性能瓶颈回顾)
- [2. 核心改进一：调换循环顺序](#heading-2-核心改进一调换循环顺序)
- [3. 核心改进二：减少非矩阵乘运算](#heading-3-核心改进二减少非矩阵乘运算)
- [4. 核心改进三：Warp 级工作分配优化](#heading-4-核心改进三warp-级工作分配优化)
- [5. Causal Mask 优化](#heading-5-causal-mask-优化)
- [6. 前向传播完整算法](#heading-6-前向传播完整算法)
- [7. 反向传播优化](#heading-7-反向传播优化)
- [8. 性能分析与对比](#heading-8-性能分析与对比)
- [总结](#heading-总结)
