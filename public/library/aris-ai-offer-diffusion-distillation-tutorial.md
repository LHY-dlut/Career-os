# Diffusion Distillation 面试 Cheat Sheet

> 来源：[ARIS-in-AI-Offer](https://github.com/wanshuiyin/ARIS-in-AI-Offer/blob/22e73822f8636ee3b52de1da6f6d2e03d1f51d4e/docs/tutorials/diffusion_distillation_tutorial.md) · 作者：Ruofeng Yang（杨若峰）及 ARIS contributors · [MIT 许可](/library/licenses/aris-ai-offer-MIT.txt)
...
> 📍 **澄清**：Flow-OPD 主要是 multi-reward RL alignment paper，与本文 few-step inference distillation 主线略偏；这里出现是因为 name 包含 "Distillation"，详细讨论见 [diffusion_post_training_tutorial.md](/library/aris-ai-offer-diffusion-post-training-tutorial)。
...
- 两者解决不同问题，并非替代关系；详细 alignment 内容见 [`diffusion_post_training_tutorial.md`](/library/aris-ai-offer-diffusion-post-training-tutorial)
