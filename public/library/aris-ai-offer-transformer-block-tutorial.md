# Transformer Block 面试 Cheat Sheet

> 来源：[ARIS-in-AI-Offer](https://github.com/wanshuiyin/ARIS-in-AI-Offer/blob/22e73822f8636ee3b52de1da6f6d2e03d1f51d4e/docs/tutorials/transformer_block_tutorial.md) · 作者：Ruofeng Yang（杨若峰）及 ARIS contributors · [MIT 许可](/library/licenses/aris-ai-offer-MIT.txt)
...
完整可跑脚本见 [`code/transformer_block.py`](https://raw.githubusercontent.com/wanshuiyin/ARIS-in-AI-Offer/22e73822f8636ee3b52de1da6f6d2e03d1f51d4e/docs/tutorials/code/transformer_block.py)（纯 PyTorch、CPU 秒级跑完 9 个 demo [D01]–[D09]）。四个入口类对应本文四个"block 时代"：`VanillaEncoderLayer2017`、`VanillaSeq2SeqDecoderLayer2017`（§2）、`GPT2StyleDecoderLayer`（§3）、`ModernDecoderBlock`（§4/§1.1，`ffn=` 可换成 `DenseFFN`/`GatedFFN`/`MoEFFN`）。正文展示三段最核心的代码，其余 demo 是脚本里的独立函数。
...
- **同系列教程** — [attention_tutorial.md](/library/aris-ai-offer-attention-tutorial)、[normalization_init_tutorial.md](/library/aris-ai-offer-normalization-init-tutorial)、[moe_tutorial.md](/library/aris-ai-offer-moe-tutorial)、[long_context_rope_yarn_mla_tutorial.md](/library/aris-ai-offer-long-context-rope-yarn-mla-tutorial)、[linear_sparse_attention_tutorial.md](/library/aris-ai-offer-linear-sparse-attention-tutorial)、[quantization_tutorial.md](/library/aris-ai-offer-quantization-tutorial)、[lora_peft_tutorial.md](/library/aris-ai-offer-lora-peft-tutorial)、[llm_inference_serving_tutorial.md](/library/aris-ai-offer-llm-inference-serving-tutorial)
