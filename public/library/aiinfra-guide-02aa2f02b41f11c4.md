> 来源：[AIInfraGuide](https://github.com/caomaolufei/AIInfraGuide/blob/a3b63eeb81d6d36a3c42c8cfc5a1bdd96e36bab1/docs/guides/%E6%A8%A1%E5%9D%97%E4%B8%89-%E5%88%86%E5%B8%83%E5%BC%8F%E8%AE%AD%E7%BB%83/1.2%20%E7%8E%AF%E5%A2%83%E6%90%AD%E5%BB%BA%E4%B8%8E%E5%88%86%E5%B8%83%E5%BC%8F%E5%90%AF%E5%8A%A8.md) · 作者：草帽路飞（caomaolufei）及 AIInfraGuide contributors · [MIT 许可](/library/licenses/aiinfra-guide-MIT.txt)
...
- [第二部分：torchrun 启动机制](#heading-第二部分torchrun-启动机制)
  - [6. 为什么需要专门的启动器](#heading-6-为什么需要专门的启动器)
  - [7. 从 torch.distributed.launch 到 torchrun](#heading-7-从-torchdistributedlaunch-到-torchrun)
  - [8. torchrun 注入的环境变量](#heading-8-torchrun-注入的环境变量)
  - [9. 单机多卡启动](#heading-9-单机多卡启动)
  - [10. 多机多卡启动与 Rendezvous](#heading-10-多机多卡启动与-rendezvous)
  - [11. torchrun 的弹性与容错能力](#heading-11-torchrun-的弹性与容错能力)
- [第三部分：NCCL 环境变量与通信调试](#heading-第三部分nccl-环境变量与通信调试)
  - [12. NCCL 是什么，为什么要调它](#heading-12-nccl-是什么为什么要调它)
  - [13. 排查第一招：NCCL_DEBUG](#heading-13-排查第一招nccl-debug)
  - [14. 指定网卡与 IB 设备](#heading-14-指定网卡与-ib-设备)
  - [15. 调试用开关：P2P 与 SHM](#heading-15-调试用开关p2p-与-shm)
  - [16. CUDA_VISIBLE_DEVICES 与设备绑定](#heading-16-cuda-visible-devices-与设备绑定)
  - [17. 一个排障速查流程](#heading-17-一个排障速查流程)
- [第四部分：动手写第一个多卡训练脚本](#heading-第四部分动手写第一个多卡训练脚本)
  - [18. 最小 DDP 脚本的五段式骨架](#heading-18-最小-ddp-脚本的五段式骨架)
  - [19. 完整可运行模板](#heading-19-完整可运行模板)
  - [20. 逐段拆解](#heading-20-逐段拆解)
  - [21. 仅 rank 0 干活的工程惯例](#heading-21-仅-rank-0-干活的工程惯例)
  - [22. 首次跑多卡的常见踩坑](#heading-22-首次跑多卡的常见踩坑)
- [总结](#heading-总结)
