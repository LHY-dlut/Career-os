# Diffusion Post-Training Interview Cheat Sheet

> 来源：[ARIS-in-AI-Offer](https://github.com/wanshuiyin/ARIS-in-AI-Offer/blob/22e73822f8636ee3b52de1da6f6d2e03d1f51d4e/docs/tutorials/diffusion_post_training_tutorial_en.md) · 作者：Ruofeng Yang（杨若峰）及 ARIS contributors · [MIT 许可](/library/licenses/aris-ai-offer-MIT.txt)
...
👉 [*Modern Diffusion Post-Training: Flow-GRPO · DGPO · DiffusionNFT*](/library/aris-ai-offer-modern-diffusion-post-training-tutorial-en)
...
A readable implementation of the SDE step + Gaussian log-prob + ratio + closed-form KL is in [*Modern Diffusion Post-Training* §7.1](/library/aris-ai-offer-modern-diffusion-post-training-tutorial-en).
