...
- [1. Reduce 算子基础](#heading-1-reduce-算子基础)
- [2. 版本 V0：朴素并行规约](#heading-2-版本-v0朴素并行规约)
- [3. 版本 V1：消除 Warp Divergence](#heading-3-版本-v1消除-warp-divergence)
- [4. 版本 V2：解决 Bank Conflict](#heading-4-版本-v2解决-bank-conflict)
- [5. 版本 V3：解决idle线程](#heading-5-版本-v3解决idle线程)
...
![CUDA programming model](https://caomaolufei.github.io/AIInfraGuide/images/reduce-cuda-kernel-01.png)
...
![CUDA programming model](https://caomaolufei.github.io/AIInfraGuide/images/reduce-cuda-kernel-02.png)
...
![reduce-cuda-kernel-03](https://caomaolufei.github.io/AIInfraGuide/images/reduce-cuda-kernel-03.png)
...
![reduce-cuda-kernel-04](https://caomaolufei.github.io/AIInfraGuide/images/reduce-cuda-kernel-04.png)
