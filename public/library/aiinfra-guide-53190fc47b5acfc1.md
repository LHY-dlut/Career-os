...
- [1. 从硬件视角认识 Warp](#heading-1-从硬件视角认识-warp)
- [2. SIMT 执行模型](#heading-2-simt-执行模型)
- [3. Warp Divergence：分支的代价](#heading-3-warp-divergence分支的代价)
- [4. Warp Shuffle：线程间数据交换利器](#heading-4-warp-shuffle线程间数据交换利器)
- [5. Warp 级原语与进阶技巧](#heading-5-warp-级原语与进阶技巧)
- [6. 实战案例：Warp 级归约](#heading-6-实战案例warp-级归约)
- [总结](#heading-总结)
